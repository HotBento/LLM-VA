...
def convert_phi3_weights(phi, cfg: HookedTransformerConfig):
    ...
    for l in range(cfg.n_layers):
        ...
        state_dict[f"blocks.{l}.ln1.b"] = torch.zeros(cfg.d_vocab, dtype=cfg.dtype, device=cfg.device)
        ...
        state_dict[f"blocks.{l}.ln2.b"] = torch.zeros(cfg.d_vocab, dtype=cfg.dtype, device=cfg.device)
